  ...
  return (
    <>
      ...
      <div style={{ ...S, padding: "48px 48px 80px" }}>
        ...
        <div style={{ marginTop: 48, background: "var(--brick-wash)", border: "1px solid var(--brick)", borderRadius: 6, padding: "32px 40px" }}>
          <h2 style={{ fontFamily: "var(--font-abril, 'Abril Fatface', serif)", fontWeight: 500, fontSize: "1.75rem", lineHeight: 1.1, color: "var(--ink)", margin: "0 0 8px" }}>
            Comment réserver ?
          </h2>
          <p style={{ fontFamily: "var(--font-nunito, 'Nunito Sans', sans-serif)", fontSize: "0.9375rem", color: "var(--ink-soft)", margin: "0 0 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              ...
              <div key={titre} style={{ background: "rgba(255,255,255,0.6)", border: "1px solid var(--brick)", borderRadius: 4, padding: 20 }}>
                <div style={{ fontSize: "1.5rem", marginBottom: 8 }}>{emoji}</div>
                <div style={{ fontFamily: "var(--font-abril, 'Abril Fatface', serif)", fontWeight: 600, fontSize: "1rem", color: "var(--ink)", marginBottom: 6 }}>{titre}</div>
                <p style={{ fontFamily: "var(--font-nunito, 'Nunito Sans', sans-serif)", fontSize: "0.875rem", color: "var(--ink-soft)", margin: 0, lineHeight: 1.55 }}>{desc}</p>
              </div>
            ))}
          </div>
        </div>
