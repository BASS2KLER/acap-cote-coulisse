                      ...
                      <div style={{
                        ...
                        <div style={{ position: "relative", aspectRatio: "16/9", background: "var(--ink)" }}>
                          ...
                          <div style={{
                            ...
                            <div style={{ width: 48, height: 48, borderRadius: "50%", background: "var(--lavande-deep)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                              <span style={{ color: "white", fontSize: "1.2rem", marginLeft: 3 }}>▶</span>
                            </div>
                          </div>
                        </div>
                        <div style={{ padding: "14px 18px" }}>
                          <div style={{ fontFamily: "var(--font-fraunces, Fraunces, serif)", fontWeight: 400, fontSize: "1rem", color: "var(--ink)", marginBottom: 4 }}>
                            {spectacle.titre}
                          </div>
                          <div style={{ fontFamily: "var(--font-worksans)", fontSize: "0.75rem", color: "var(--ink-muted)" }}>
                            {spectacle.saison}
                          </div>
                        </div>
                      </div>
